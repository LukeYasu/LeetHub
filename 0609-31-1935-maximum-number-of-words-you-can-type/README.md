<h2> 609 31
1935. Maximum Number of Words You Can Type</h2><hr><div><p>There is a malfunctioning keyboard where some letter keys do not work. All other keys on the keyboard work properly.</p>
