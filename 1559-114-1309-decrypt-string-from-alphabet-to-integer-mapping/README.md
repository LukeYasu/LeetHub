<h2> 1559 114
1309. Decrypt String from Alphabet to Integer Mapping</h2><hr><div><p>You are given a string <code>s</code> formed by digits and <code>'#'</code>. We want to map <code>s</code> to English lowercase characters as follows:</p>
